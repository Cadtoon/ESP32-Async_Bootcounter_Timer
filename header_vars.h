// change these setting for your gmail account. I have no tested with any other email account
#define emailSenderAccount   "YOUR_EMAIL_ACCOUNT@gmail.com"
#define emailSenderPassword  "YOUR_EMAIL_PASSWORD"
#define emailRecipient  "ANY_ONE_AT_ANYWHERE.EMAIL_ADDRESS"
#define smtpServer      "smtp.gmail.com"
#define smtpServerPort  465
#define emailSubject  "Sent From ESP!"

// Timer1 is used to turn the built-in LED on and off. GPIO 2
#define LED 2

// New variables for timer functions
String timer1_on;
String timer1_off;
bool timer1_switch;
bool timer1on_trigger = 0;
bool timer1off_trigger = 0;
String timer2_on;
String timer2_off;
bool timer2_switch;
bool timer2on_trigger = 0;
bool timer2off_trigger = 0;
bool alarm_trigger = 0;

// new variables for boot counter
int bootcounter;
String bootdate = "Jan, 1, 1972"; //the Unix epoch, 00:00:00 UTC 
...
// new param for reseting counter
const char* PARAM_RESET = "Resetcounter";

// new params for timers
const char* PARAM_TIMER1ON = "Timer1on";
const char* PARAM_TIMER1OFF = "Timer1off";
const char* PARAM_TIME1SWITCH = "Timer1switch";
const char* PARAM_TIMER2ON = "Timer2on";
const char* PARAM_TIMER2OFF = "Timer2off";
const char* PARAM_TIME2SWITCH = "Timer2switch";
